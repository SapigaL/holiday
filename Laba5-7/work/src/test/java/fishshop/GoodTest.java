...
class GoodTest {
    ...
    void setUp() {
        ...
        shop = new FishShop();
        shop.addGood(new Fish(LocationType.SEA, 23, 140, "Karas",ColorType.BLACK,Mixed.NO,FishType.SALINE));
        shop.addGood(new Cavlar(LocationType.SEA, 23, 140, "IKRA",ColorType.BLACK,Mixed.NO,FishType.SALINE));
        shop.addGood(new Stuffing(LocationType.SEA, 23, 140, "Karas+Okyn",ColorType.BLACK,Mixed.NO,FishType.SALINE));
